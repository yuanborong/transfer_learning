...
#
mean_auc_csv_name = 'transfer_all_data_mean_multiple_weight'
...
# initialize the array of expand the weight
arr_multiple_weight = [10 , 20 , 50 , 100]

for multiple in arr_multiple_weight:
    ...
    for data_num in range(1, 6):
        ...
        Weight_importance_all_data *= multiple
        ...
        for disease_num in range(disease_list.shape[0]):
            ...
            #     disease_list.iloc[disease_num, 0], auc_global_dataframe_columns[data_num - 1]] = auc_by_global_model
    ...
    print("Finishing multiple " + str(multiple))
