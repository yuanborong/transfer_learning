...
for data_num in range(1, 6):
    ...
    for disease_num in range(len(disease_list)):
        ...
        gbm_All.fit(source_X_train_expect_this_group, source_y_train_expect_this_group)
        ...
        gbm_large_group = GradientBoostingClassifier(init=gbm_source, n_estimators=middle_round, learning_rate=0.1,
                                                     subsample=0.8, loss='deviance', max_features='sqrt', max_depth=3,
