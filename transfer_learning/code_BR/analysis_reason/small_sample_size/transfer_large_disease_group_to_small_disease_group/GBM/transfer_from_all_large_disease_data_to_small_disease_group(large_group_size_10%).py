...
# csv_path
csv_path = '/home/huxinhou/WorkSpace_BR/transfer_learning/result/analysis_reason/small_sample_size/transfer_from_large_disease_group_to_small_disease_group(large_group_size_10%)/GBM/'
