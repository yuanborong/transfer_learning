...
# csv_path
csv_path = '/home/huxinhou/WorkSpace_BR/transfer_learning/result/transfer_from_large_disease_group_to_small_disease_group/GBM/'
...
for data_num in range(1, 6):
    ...
    for disease_num in range(len(disease_list)):
        ...
        gbm_All.fit(X_train_source_data, y_train_source_data)
