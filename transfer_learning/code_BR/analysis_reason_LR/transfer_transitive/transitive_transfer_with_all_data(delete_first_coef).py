...
# csv_path
csv_path = '/home/huxinhou/WorkSpace_BR/transfer_learning/result/analysis_reason_LR/transfer_transitive(delete_first_coef)/'
...
for data_num in range(1, 6):
    ...
    for disease_num in range(len(disease_list)):
        ...
        # transfer to X_test
        X_test_target = X_test_source * Weight_importance_from_middle_data
